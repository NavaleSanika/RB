...
function NavBar(){
    return(
        ...
        <div style={{backgroundColor:'#fab0de',color:'#2ba0e9',zIndex:10}}>
            <nav className="navbar navbar-expand-lg navbar-light p-0 m-0 " >
                <div className="container-fluid  ">
                  <div className="navbar-brand d-flex align-items-center" style={{color:'#063b5c',fontSize:'30px', fontWeight:"600"}}>
